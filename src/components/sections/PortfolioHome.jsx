...
export default function PortfolioHome({ setView }) {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center space-y-10 text-center py-20 px-6">
      ...
      <button
        ...
        className="bg-[#030712] hover:bg-[#111827] text-white text-xs font-bold tracking-wider px-8 py-4 rounded-xl shadow-sm transition-all hover:-translate-y-0.5 my-6"
      >
