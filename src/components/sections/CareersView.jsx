...
export default function CareersView() {
  ...
  const jobs = [
    ...
    { p: 'health', sub: 'Health • Operations Architecture', n: 'Pair Team', d: 'Connecting community clinics to digital care operational infrastructure networks.', u: 'https://www.pairteam.com/careers' },
    { p: 'health', sub: 'Health • Companion Logistics', n: 'Papa', d: 'Providing scaled companion networks and assistance arrays for seniors and families.', u: 'https://www.papa.com/careers' },
    ...
    { p: 'climate', sub: 'Climate • Sequestration', n: 'Charm Industrial', d: 'Carbon removal deployment tracking structures via high-density bio-oil sequestration loops.', u: 'https://charmindustrial.com/careers' },
    ...
    { p: 'education', sub: 'Education • Reference Systems', n: 'Chegg', d: 'Digital learning portal hub delivering student-focused reference tracking databases.', u: 'https://careers.chegg.com/' },
    ...
    { p: 'civic', sub: 'Civic • Semantic Mapping', n: 'Topos', d: 'Advanced geographical semantic mapping engines tracing demographic community parameters.', u: 'https://topos.ai/careers' },
    ...
    { p: 'fintech', sub: 'FinTech • Consumer Banking', n: 'Chime', d: 'Consumer fee-free transaction banking matrices tracking deposit pipeline loops.', u: 'https://www.chime.com/about/careers/' },
    ...
    { p: 'fintech', sub: 'FinTech • Underwriting Lending', n: 'Climb Credit', d: 'Alternative financing evaluation software tracking career path tuition lending metrics.', u: 'https://climbcredit.com/careers' },
